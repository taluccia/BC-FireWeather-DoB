...
setwd('c:/data/firespread/') ###########where the ascii files (burn date) reside. also used this as output dir to write the reclassified images.
tpath<-"c:/rfiles/fires/canada/data/weather/" #########where the lookup tables reside
```
